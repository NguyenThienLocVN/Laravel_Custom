...
return [
	...
	"prices" => [
	"already_exists" => "That Price already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Price. Please try again.",
	"delete_error" => "There was a problem deleting this Price. Please try again.",
	"not_found" => "That Price does not exist.",
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://localhost:1997/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
