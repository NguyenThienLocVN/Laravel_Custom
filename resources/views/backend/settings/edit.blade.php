	...
	<div class="box-body setting-block">
		...
		<ul id="myTab" class="nav nav-tabs setting-tab-list" role="tablist">
			<li role="presentation" class="active">
				<a href="#tab0" aria-controls="home" role="tab" data-toggle="tab">{{ trans('labels.backend.settings.price') }}</a>
			</li>
			<li role="presentation">
				<a href="#tab1" aria-controls="0" role="tab" data-toggle="tab">{{ trans('labels.backend.settings.seo') }}</a>
			</li>
			<li role="presentation">
		...
		<div id="myTabContent" class="tab-content setting-tab">
			...
			<div role="tabpanel" class="tab-pane active" id="tab0">
				...
				<div class="form-group">
					{{ Form::label('serviceprice', trans('validation.attributes.backend.settings.serviceprice'), ['class' => 'col-lg-2 control-label'])}}
					<div class="col-sm-1">
						{{ Form::number('serviceprice', null,['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.settings.serviceprice'),'rows' => 2]) }}
					</div>
				</div>

				<!-- Update ship local price -->
				<div class="form-group">
					{{ Form::label('shipinsideprice', trans('validation.attributes.backend.settings.shipinsideprice'), ['class' => 'col-lg-2 control-label'])}}
					<div class="col-sm-1">
						{{ Form::number('shipinsideprice', null,['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.settings.shipinsideprice'),'rows' => 2]) }}
					</div>
				</div>

				<!--Update exchange rate-->
				<div class="form-group">
					{{ Form::label('exchangerate', trans('validation.attributes.backend.settings.exchangerate'), ['class' => 'col-lg-2 control-label'])}}
					<div class="col-sm-1">
						{{ Form::number('exchangerate', null,['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.settings.exchangerate'),'rows' => 2]) }}
					</div>
				</div>

				<!-- Update ship GZ-HN price -->
				<div class="form-group">
					{{ Form::label('shipoutsideprice', trans('validation.attributes.backend.settings.shipoutsideprice'), ['class' => 'col-lg-2 control-label'])}}
					<div class="col-sm-1">
						{{ Form::number('shipoutsideprice', null,['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.settings.shipoutsideprice'),'rows' => 2]) }}
					</div>
				</div>
			</div>
